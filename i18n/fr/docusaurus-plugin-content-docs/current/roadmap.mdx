...
## v0.8 et au-delà (indicatif)

- **La carte grandit :** frontières de namespace et de groupe, volume porté par
  l'arête elle-même, traitement distinct des pairs externes et non détectés —
  sans perturber les canaux que la carte encode déjà.
- **Cibles virtuelles :** bases de données, caches et courtiers de messages
  comme nœuds à part entière de la carte, dérivés des spans sortants déjà
  stockés — sans nouvel agent ni nouvelle table.
- **Navigation par couches :** une structure qui grandit avec le produit tout en
  gardant court le chemin des cinq premières minutes.
