...
<ReleaseEntry version="0.7.0" date="en développement" status="in-progress" statusLabel="En cours">

Le tronc `main`. Direction prévue (voir la
[Feuille de route](/docs/roadmap)) : davantage de clients — une CLI avec
`--fail-on` pour les garde-fous de CI et une recette Grafana documentée
par-dessus l'API du hub —, des services qui déclarent eux-mêmes leur domaine,
leur environnement et leur criticité, un étiquetage automatique plus riche
depuis les labels Kubernetes, et la comptabilité du trafic inter-zones dont la
conception a été livrée en v0.6.
