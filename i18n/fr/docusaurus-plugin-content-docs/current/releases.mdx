...
<ReleaseEntry version="0.8.0" date="en développement" status="in-progress" statusLabel="En cours">

Le tronc `main`. Direction prévue (voir la
[Feuille de route](/docs/roadmap)) : la carte des services grandit — frontières
de namespace et de groupe, volume porté par l'arête elle-même, traitement
distinct des pairs externes et non détectés, et des **cibles virtuelles**
(bases de données, caches et courtiers de messages comme nœuds à part entière)
dérivées des spans sortants déjà stockés. Plus une navigation qui grandit avec
le produit.
