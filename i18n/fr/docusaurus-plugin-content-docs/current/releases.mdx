...
<ReleaseEntry version="0.10.0" date="en développement" status="in-progress" statusLabel="En cours">

Le tronc `main`. Direction prévue (voir la
[Feuille de route](/docs/roadmap)) : classer le transport à partir des étiquettes
Kubernetes plutôt que des noms de charges de travail, l'attribution des coûts aux
côtés du module énergie, et les plans de contrôle autres qu'Istio.
