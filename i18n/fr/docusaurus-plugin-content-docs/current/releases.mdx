...
<ReleaseEntry version="0.20.0" date="en développement" status="in-progress" statusLabel="En cours">
...
**Correctif.** Le [Service Mesh](/docs/signals/mesh) construisait ses listes
d'espaces de noms, de charges de travail et de configuration à partir du
registre du cluster sans appliquer le projet de l'appelant : un compte limité à
un projet — le compte de démonstration partagé, par exemple — pouvait lire chaque
espace de noms, chaque charge et chaque politique du cluster. Le registre est
désormais restreint aux espaces de noms que les projets de l'appelant
atteignent ; une identité globale voit toujours le cluster entier. Aucun
changement de schéma ni d'API.

[Release GitHub](https://github.com/avuruvision/avuru-obs/releases/tag/v0.19.1)
· [changelog](/changelog/v0-19-1).
