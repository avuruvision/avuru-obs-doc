...
Elle a été trouvée en indexant la garde de chaque route pour construire le
nouvel [onglet Accès](/changelog/settings-storage-access) — la même idée
appliquée au produit : déduire les règles de ce que le serveur applique, plutôt
que de les écrire deux fois.
